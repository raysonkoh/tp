...
public class ParserUtil {
    ...
    private static final CountryManager COUNTRY_MANAGER = new CountryManager();
    ...
    public static Country parseCountry(String countryCode) throws ParseException {
        requireNonNull(countryCode);
        String trimmedCountryCode = countryCode.trim();
        Country country = COUNTRY_MANAGER.getCountryFromCode(trimmedCountryCode);
